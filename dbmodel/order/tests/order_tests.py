...
class OrderTest(unittest.TestCase):
    ...
    def setUp(self):
        ...
        Inventory().add_item(1, 3, 3, 1, 'un', 'BRL', 1300, '2017-6-15')
        Inventory().add_item(2, 3, 3, 2, 'un', 'BRL', 2300, '2017-6-15')
        Inventory().add_item(3, 3, 3, 3, 'un', 'BRL', 3300, '2017-6-15')
        Inventory().add_item(4, 3, 3, 4, 'un', 'BRL', 4300, '2017-6-15')
        Inventory().add_item(5, 3, 3, 5, 'un', 'BRL', 5300, '2017-6-15')
        # Inventory().add_item(6, 3, 3, 6, 'un', 'BRL', 6300, '2017-6-15')
        # Inventory().add_item(7, 3, 3, 7, 'un', 'BRL', 7300, '2017-6-15')
        # Inventory().add_item(8, 3, 3, 8, 'un', 'BRL', 8300, '2017-6-15')
        # Inventory().add_item(9, 3, 3, 9, 'un', 'BRL', 9300, '2017-6-15')
        # Inventory().add_item(10, 3, 3, 10, 'un', 'BRL', 10300, '2017-6-15')
    ...
    def test_create_order(self):
        ...
        inventory = process_basket(basket, parameters, location)

        Order().add_item(1, inventory, ordered_qty, payment_info)
